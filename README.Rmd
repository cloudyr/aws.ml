...
**aws.ml** is a package for the [Amazon Machine Learning](https://aws.amazon.com/aml/) API.
...
[![CRAN](https://www.r-pkg.org/badges/version/aws.ml)](https://cran.r-project.org/package=aws.ml)
![Downloads](https://cranlogs.r-pkg.org/badges/aws.ml)
[![Travis Build Status](https://travis-ci.org/cloudyr/aws.ml.png?branch=master)](https://travis-ci.org/cloudyr/aws.ml)
[![Appveyor Build Status](https://ci.appveyor.com/api/projects/status/PROJECTNUMBER?svg=true)](https://ci.appveyor.com/project/cloudyr/aws.ml)
[![codecov.io](https://codecov.io/github/cloudyr/aws.ml/coverage.svg?branch=master)](https://codecov.io/github/cloudyr/aws.ml?branch=master)

This package is not yet on CRAN. To install the latest development version you can install from the cloudyr drat repository:

```R
# latest stable version
install.packages("aws.ml", repos = c(cloudyr = "http://cloudyr.github.io/drat", getOption("repos")))
```
...
remotes::install_github("cloudyr/aws.ml")
```
